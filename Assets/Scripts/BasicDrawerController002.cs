...
public class BasicDrawerController002 : MonoBehaviour
{
    private Animator drawerAnim;
    private bool drawerOpen = false;

    [Header("Animation Names")]
    [SerializeField] private string openAnimationName = "DrawerOpen002";
    [SerializeField] private string closeAnimationName = "DrawerClose002";
