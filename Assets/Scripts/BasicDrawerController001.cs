...
public class BasicDrawerController001 : MonoBehaviour
{
    private Animator drawerAnim;
    private bool drawerOpen = false;

    [Header("Animation Names")]
    [SerializeField] private string openAnimationName = "DrawerOpen001";
    [SerializeField] private string closeAnimationName = "DrawerClose001";
